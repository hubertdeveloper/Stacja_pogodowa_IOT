...
// ---------- WI-FI / THINGSPEAK ----------
const char* WIFI_SSID = "Hubert's Galaxy S21 5G";
const char* WIFI_PASS = "fkxd6250";
#define THINGSPEAK_SERVER "http://api.thingspeak.com/update"
#define THINGSPEAK_APIKEY "OJ6R56S292JMLT4D"


// ---------- SUPABASE ----------
#define SUPABASE_URL "https://xuwrzuxlxiacahxqcqpx.supabase.co/rest/v1/pogoda"
#define SUPABASE_APIKEY "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh1d3J6dXhseGlhY2FoeHFjcXB4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NTgwNTUxNiwiZXhwIjoyMDgxMzgxNTE2fQ.JX8Zl_kryS7apV0PQ4-RvxTUkazf1qNJmC8gU2zVGgw"
